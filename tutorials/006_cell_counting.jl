...
JIVECore.Visualize.showBoxplot(
    [df.count, df.perimeter, df.area], 
    ["Counts" "Perimeter" "Area"], 
    color=:silver
    )

# ╔═╡ 54daefb6-2477-4f00-9804-e970f2ca89d9
StatsPlots.scatter(df.mean, df.area, xlabel="Mean", ylabel="Area", 
    title="Mean Intensity vs Perimeter", legend=false, markersize=4)
...
manifest_format = "2.0"
project_hash = "a83e3d78f031e665ca37ca73c5da37ebce005acd"
